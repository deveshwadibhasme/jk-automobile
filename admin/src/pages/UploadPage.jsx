    ...
    <div className="relative min-h-screen py-5 max-w-screen-2xl mx-auto bg-[#302e2e] overflow-hidden font-sans">
      ...
      focus:ring-2 focus:ring-blue-400 outline-none transition"
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mt-10">
            <button
              type="submit"
              className="flex-1 max-w-[150px] py-3 text-white mx-auto w-full font-semibold rounded-lg shadow-lg bg-linear-to-br from-green-500 to-green-700 hover:from-green-600 hover:to-green-800 transition transform hover:scale-105"
            >
            ...
            <button
              type="button"
              onClick={handleReset}
              className="flex-1 max-w-[150px] py-3 mx-auto w-full text-gray-800 font-semibold rounded-lg shadow-lg bg-transparent border-2 border-gray-400 hover:bg-gray-100 transition transform hover:scale-105"
            >
              Reset
            </button>
          </div>
